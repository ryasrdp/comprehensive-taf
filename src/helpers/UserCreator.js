...
export default class UserCreator {
  static createUser(options = {}) {
    ...
    return {
      ...
      userDob: format(fakerator.date.between(new Date('1970-01-01'), new Date('1990-01-01')), 'yyyy-MM-dd'),
  ...
  static addUser(user, userNumber) {
    const userData = UserCreator.createUser();
    DataStorage.setNamespace('USER', userNumber, userData);
  }

  static getUser(userName, userNumber) {
    return DataStorage.getStorage(userName, userNumber);
  }
}
